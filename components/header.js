        ...
        <section className = 'header'>
          <article className = 'contenido-header'>
            <div className = 'icono-menu-lateral-header icono-menu-lateral-wrapper hidden'>
              <img className = 'icono-menu-lateral' src = '/icons/header/menu.svg' alt = 'menu lateral' onClick = { handleChangeModal } />
            </div>
        ...
        <nav className = 'nav'>
          <article className = 'contenido-nav'>
            <div className = 'icono-menu-lateral-wrapper'>
              <img className = 'icono-menu-lateral-nav' src = '/icons/nav/menu.svg' alt = 'menu lateral' onClick = { handleChangeModal2} />
            </div>
